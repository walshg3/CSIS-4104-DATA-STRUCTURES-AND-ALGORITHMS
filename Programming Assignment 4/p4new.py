...
def haversine_distance(lat1, lng1, lat2, lng2) :
    ...
    latdif = lat2_radians - lat1_radians
    lngdif = lng2_radians - lng1_radians

    a = math.sin(latdif / 2)**2 + math.cos(lat1_radians) * math.cos(lat2_radians) * math.sin(lngdif / 2)**2
...
def test_with_highway_graph(L) :
    ...
    graph = parse_highway_graph_data('SaintMartin.txt')
